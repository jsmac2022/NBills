...
import com.nictbills.app.activities.DTHRechargeActivity;
import com.nictbills.app.activities.DashboardActivity;
import com.nictbills.app.activities.LoginActivity;
import com.nictbills.app.activities.MyBottomSheetDialog;
import com.nictbills.app.activities.PaymentStatusActivity;
...
public class LICPaymentActivity extends BaseActivity implements MyBottomSheetDialog.CallBack {

private ListView app_listView;
private LinearLayout pay_now_UPI_LinearLayout, upi_id_click_linear_layout,parent_id_UPI;
private String email,reward_status,customeID,operator_Id,service,merchantTranId,billSaveStatus,service_id,txnDate,amount,UPI,CUST_UPI_ID,credential,pay_for,lic_Amount;
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_licpayment);
    ...
    try {
        ...
        LICPaymentActivity.AppAdapter adapter = new LICPaymentActivity.AppAdapter(pm, launchables);
        app_listView.setAdapter(adapter);

        Intent intentGet = getIntent();
        pay_for = intentGet.getStringExtra("PAY_FOR");
        customeID = intentGet.getStringExtra("POLICY_NUMBER");
        reward_status = intentGet.getStringExtra("REWARD_STATUS");
        email = intentGet.getStringExtra("EMAIL");
        lic_Amount = intentGet.getStringExtra("AMOUNT");

        /*int y = Integer.parseInt(rechargeAmount);
        int z = y - reward_point;
        amount_Tv.setText("₹ "+z);*/
        amount_Tv.setText("₹ "+lic_Amount);
        total_amount_TV.setText(getString(R.string.pay)+" "+"₹ "+lic_Amount);
        ...
        CreateQrRequest dataSendQR = new CreateQrRequest();
            dataSendQR.setEmail(email);
            dataSendQR.setAmount(lic_Amount);
            dataSendQR.setCanumber(customeID);
            dataSendQR.setUseReward(reward_status);
            createUPIQRorder(dataSendQR);
        ...
        if (pay_for.equalsIgnoreCase("LIC")){

        Intent intentUPI= new Intent(LICPaymentActivity.this, LicBillsActivity.class);
        startActivity(intentUPI);
        finish();

        }else {
        Intent intent= new Intent(LICPaymentActivity.this, DashboardActivity.class);
        startActivity(intent);
        finish();
        }
        ...
        CreateLICRequest dataVpaRequest = new CreateLICRequest();

            dataVpaRequest.setVpa(CUST_UPI_ID);
            dataVpaRequest.setCanumber(customeID);
            dataVpaRequest.setAmount(lic_Amount);
            dataVpaRequest.setUseReward(reward_status);
            dataVpaRequest.setEmail(email);
            createUPIVPAorder(dataVpaRequest);
...
class AppAdapter extends ArrayAdapter<ResolveInfo> {
    ...
    AppAdapter(PackageManager pm, List<ResolveInfo> apps) {
        super(LICPaymentActivity.this, R.layout.row, apps);
        this.pm = pm;
        this.apps = apps;
    }
    ...
    public void onBackPressed() {
        ...
        if (pay_for.equalsIgnoreCase("LIC")){
            ...
            Intent intentUPI= new Intent(LICPaymentActivity.this, DTHRechargeActivity.class);
            startActivity(intentUPI);
            finish();
        }
    ...
    private void verifyVPATxn(UpiVpaDTO vpaDTO) {
        ...
        Call<UpiVpaDTO> call = retroFitInterface.vpaVerify_txn(credential, vpaDTO);
        ...
        call.enqueue(new Callback<UpiVpaDTO>() {
            ...
            public void onResponse(Call<UpiVpaDTO> call, Response<UpiVpaDTO> response) {
                ...
                if (response.code() == 200) {
                    ...
                    if (body.getTxnStatus().equalsIgnoreCase("SUCCESS")){
                        ...
                        if (bottomSheet!=null){
                            ...
                            try {
                                ...
                                Toast.makeText(LICPaymentActivity.this,getString(R.string.payment_successful) , Toast.LENGTH_SHORT).show();
                            }
                        ...
                        if (body.getBillSaveStatus().equalsIgnoreCase("SUCCESS")){
                            ...
                            Intent intent = new Intent(LICPaymentActivity.this, PaymentStatusActivity.class);
                        ...
                        if (bottomSheet!=null){
                            ...
                            try {
                                ...
                                Toast.makeText(LICPaymentActivity.this, getString(R.string.payment_failed), Toast.LENGTH_SHORT).show();
                    ...
                    SweetAlertDialog sweetAlertDialog = new SweetAlertDialog(LICPaymentActivity.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE);
                    ...
                    sweetAlertDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        ...
                        public void onClick(SweetAlertDialog sDialog) {
                            ...
                            editor.clear();
                            editor.apply();
                            Intent intent = new Intent(LICPaymentActivity.this, LoginActivity.class);
                            startActivity(intent);
                            finish();
                    ...
                    Toast.makeText(LICPaymentActivity.this, getString(R.string.something_went_wrong_please_try_again_later), Toast.LENGTH_SHORT).show();
    ...
    private void createUPIVPAorder(CreateLICRequest licRequest) {

        final ProgressDialog progressLog;
        progressLog = new ProgressDialog(LICPaymentActivity.this);
        ...
        Call<LICOrderResponse> call = retroFitInterface.createLicOrder(credential, licRequest);

        call.enqueue(new Callback<LICOrderResponse>() {
            @Override
            public void onResponse(Call<LICOrderResponse> call, Response<LICOrderResponse> response) {
                progressLog.dismiss();

                LICOrderResponse dataSend = response.body();
                ...
                if (response.code() == 200) {
                    ...
                    if (dataSend.getCode().equalsIgnoreCase("OK")){
                        ...
                        bottomSheet.setCallBack(LICPaymentActivity.this);
...
//                        bottomSheet.show(getSupportFragmentManager(), "ModalBottomSheet");
            ...
            @Override
            public void onFailure(Call<LICOrderResponse> call, Throwable t) {
                progressLog.dismiss();
                Log.e("MSG", t.getMessage());
    ...
    private void createUPIQRorder(CreateQrRequest qrRequest) {
        ...
        Call<MobileRechargeCreateOrderResponse> call = retroFitInterface.createQROrderLIC(credential, qrRequest);
        ...
        call.enqueue(new Callback<MobileRechargeCreateOrderResponse>() {
            ...
            public void onResponse(Call<MobileRechargeCreateOrderResponse> call, Response<MobileRechargeCreateOrderResponse> response) {
                ...
                if (response.code() == 200) {
                    ...
                    Toast.makeText(LICPaymentActivity.this, getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show();
                }
...
*/
    ...
    private void verifyQRTxn(UpiVpaDTO vpaDTO) {
        ...
        Call<UpiVpaDTO> call = retroFitInterface.verifyLicQRTxn(credential, vpaDTO);
